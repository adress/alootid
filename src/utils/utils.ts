/**
 * This function creates a svg element with the copy svg icon from fontawesome
 * @returns SVGSVGElement 
 */
export function createSvgIconCopy() {
    ...
    svgElement.setAttribute('title', 'Copy to clipboard');
    svgElement.setAttribute('role', 'img');
    svgElement.setAttribute('aria-label', 'Copy to clipboard');
    ...
    titleElement.textContent = 'Copy to clipboard';

    const pathElement = document.createElementNS('http://www.w3.org/2000/svg', 'path');
    pathElement.setAttribute('title', 'Copy to clipboard');
    ...
    svgElement.append(titleElement, pathElement);
    return svgElement;
}
