"use strict";
function copyItemId(event) {
    var _a;
    const svgElement = event.target;
    if (svgElement.nodeName !== 'svg')
        return;
    const texto = (_a = svgElement.parentElement) === null || _a === void 0 ? void 0 : _a.textContent;
    const textoInterez = texto === null || texto === void 0 ? void 0 : texto.substring(texto.search('ID#') + 4);
    const id = textoInterez === null || textoInterez === void 0 ? void 0 : textoInterez.split(' ')[0];
    navigator.clipboard.writeText(`@alootid +${id}`);
    svgElement.style.fill = "green";
}
function copyMonsterMap(event) {
    var _a;
    const svgElement = event.target;
    if (svgElement.nodeName !== 'svg')
        return;
    const mapName = (_a = svgElement.parentElement) === null || _a === void 0 ? void 0 : _a.childNodes[0].childNodes[0].textContent;
...
nameRows.forEach((row) => {
    ...
    (_a = nodo[0].parentElement) === null || _a === void 0 ? void 0 : _a.append(svgElement);
});
const tableTr = document.querySelectorAll('.filled_header_mob')[0];
const tableBody = tableTr.parentElement;
const mapContainer = tableBody === null || tableBody === void 0 ? void 0 : tableBody.childNodes[1].childNodes[2].childNodes[0];
